...
- (void)viewDidLoad
{
    ...
    [_testArray addObject:@"one"];
    [_testArray addObject:@"two"];
    [_testArray addObject:@"three"];
...
{
    NSIndexPath *previousSelectedIndexPath = _selectedIndexPath;  // <- save previously selected cell
